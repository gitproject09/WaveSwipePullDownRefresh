package com.sopan.refresh_layout.activity;
...
import com.sopan.refresh_layout.R;
import com.sopan.refresh_layout.layout.WaveSwipeRefreshLayout;
...
public class MainActivity extends AppCompatActivity implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void setSampleData() {
        ...
        for (int i = 0; i < 50; i++) {
            sampleArrayStr.add("List item " + i);
        }
